...
#     match_fields={"hdr.ipv4.dstAddr": ["10.0.0.3", 32]},
#     action_name="MyIngress.ipv4_forward",
#     action_params={"dstAddr": net.get("h1").intfs[0].mac, "port": 2},
# )
...
#     match_fields={"hdr.ipv4.dstAddr": ["10.0.0.4", 32]},
#     action_name="MyIngress.ipv4_forward",
#     action_params={"dstAddr": net.get("h2").intfs[0].mac, "port": 3},
# )
...
#     action_name="MyIngress.ipv4_forward",
#     action_params={"dstAddr": net.get("c2").intfs[0].mac, "port": 1},
# )
...
#     match_fields={"hdr.ipv4.dstAddr": ["10.0.0.1", 32]},
#     action_name="MyIngress.ipv4_forward",
#     action_params={"dstAddr": net.get("c1").intfs[0].mac, "port": 2},
# )
