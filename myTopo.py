...
class MyTopo( Topo ):
    ...
    def build( self, n, k ):
        ...
        hosts['h5'] = self.addHost('h5', ip = "10.0.0.5", mac = '00:00:00:00:00:05')
        hosts['h6'] = self.addHost('h6', ip = "10.0.0.6", mac = '00:00:00:00:00:06')
        hosts['c1'] = self.addHost('c1', ip = "10.0.0.7", mac = '00:00:00:00:00:07')
        hosts['c2'] = self.addHost('c2', ip = "10.0.0.8", mac = '00:00:00:00:00:08')
        hosts['c3'] = self.addHost('c3', ip = "10.0.0.9", mac = '00:00:00:00:00:09')
